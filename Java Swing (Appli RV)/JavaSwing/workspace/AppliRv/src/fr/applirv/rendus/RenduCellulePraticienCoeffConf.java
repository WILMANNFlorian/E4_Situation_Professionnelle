...
public class RenduCellulePraticienCoeffConf extends DefaultTableCellRenderer {
	
	private VueListeVisiteurs vue ;	
	private ModeleListePraticiensCoeffConf modeleTabPraticiens ;
	private List<Praticien> lesPraticiens = ModeleAppliRV.getModele().getLesPraticiensCoeffConf() ;
	
	public RenduCellulePraticienCoeffConf(){
		super() ;
	}
