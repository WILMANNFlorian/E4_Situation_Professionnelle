...
public class RenduCellulePraticienDate extends DefaultTableCellRenderer {
	
	private VueListeVisiteurs vue ;	
	private ModeleListePraticiensDate modeleTabPraticiens ;
	private List<Praticien> lesPraticiens = ModeleAppliRV.getModele().getLesPraticiensDate() ;
	
	public RenduCellulePraticienDate(){
		super() ;
	}
